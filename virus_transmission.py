...
def calculate_infections(starting_number_infections, reproduction_rate, num_days):
    ...
    """
    current_number_infection = starting_number_infections
    for i in range (num_days):
        current_number_infection = current_number_infection * reproduction_rate
    return round(current_number_infection)
